<template>
  <div class="container mx-auto px-4 py-8 max-w-6xl">
    ...
    <p class="text-gray-600 mb-8">
      Each repository requires its own SSH Deploy Key. Generate a unique key for each repository and add it to GitHub/GitLab.
    </p>
    ...
    >
      <div class="bg-white rounded-lg p-6 max-w-3xl w-full max-h-[90vh] overflow-y-auto" @click.stop>
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            <textarea
              :value="selectedRepo.publicKey"
              readonly
              rows="8"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 font-mono text-xs"
            ></textarea>
            <button
        ...
        <div class="flex gap-3 mt-6">
          <button
            @click="confirmRegenerateRepo = selectedRepo"
